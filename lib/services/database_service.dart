...
Future<void> _ensureRecommendationsTableExists(Database db) async {
  ...
  Future _onUpgrade(Database db, int oldVersion, int newVersion) async {
    ...
    final hasTitleColumn = checkInsColumns.any((column) => column['name'] == 'title');
